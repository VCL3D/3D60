...
if __name__ == "__main__":
    datasets = ThreeD60.get_datasets("D:\\_dev\\_datasets\\all_trino_train.txt", \
    ...
    viz = visualization.VisdomImageVisualizer("3D60", "195.251.117.120")
    dataset_loader = DataLoader(datasets, batch_size=32, shuffle=False, pin_memory=False, num_workers=0)
